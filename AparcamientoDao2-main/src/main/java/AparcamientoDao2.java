...
public class AparcamientoDao2 {
	...
	public void listVehiculos() {
		 ...
		 */
		for (Vehiculo v : apm.lstVehiculos.findAll()) {	// falta por implementar el findAll en DaoESList
	...
	public int comprobarMatricula(String matricula) {
		...
		al = apm.lstVehiculos.findAll(); // falta por implementar el findAll en DaoESList
